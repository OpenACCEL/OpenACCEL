...
cp node_modules/escodegen/escodegen.browser.min.js             bin/scripts/escodegen.js
cp node_modules/escope/escope.js                               bin/scripts/escope.js
cp node_modules/escope/node_modules/estraverse/estraverse.js   bin/scripts/estraverse.js
