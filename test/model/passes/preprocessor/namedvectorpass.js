...
suite("namedvectorpass.js", function() {
    ...
    suite("namedVectorPass", function() {
        ...
        test('replaceBrackets() y = [[1,a[0+10],b[x+5]],[2],[3],[4],[5],f([a(1,2,3),2,3],[1,2,3])]', function() {
            assert.equal(instance.replaceBrackets("y = [[1,a[0+10],b[x+5]],[2],[3],[4],[5],f([a(1,2,3),2,3],[1,2,3])]"), "y = {'0':{'0':1,'1':a[0+10],'2':b[x+5]},'1':{'0':2},'2':{'0':3},'3':{'0':4},'4':{'0':5},'5':f({'0':a(1,2,3),'1':2,'2':3},{'0':1,'1':2,'2':3})}");
        });
        test('replaceBrackets() y = [[1, a[0 + 10], b[x + 5]],[2],[3],[4],[5],f([1,2,3],[1,2,3])]', function() {
            assert.equal(instance.replaceBrackets("y = [[1,a[0+10],b[x+5]],[2],[3],[4],[5],f([a(b(1,2,3),2,3),2,3],[1,2,3])]"), "y = {'0':{'0':1,'1':a[0+10],'2':b[x+5]},'1':{'0':2},'2':{'0':3},'3':{'0':4},'4':{'0':5},'5':f({'0':a(b(1,2,3),2,3),'1':2,'2':3},{'0':1,'1':2,'2':3})}");
        });
        /**
